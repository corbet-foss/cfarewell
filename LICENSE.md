...
cfarewell 0.3.1 is licensed under **LGPL-3.0-only WITH LGPL-3.0-linking-exception**.
...
retains Apache-2.0. Existing release tags, published archives and already prepared Apache
