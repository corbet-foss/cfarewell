...
cfarewell 0.3.0 is licensed under **LGPL-3.0-only WITH LGPL-3.0-linking-exception**.
...
Previously distributed releases retain their original grants. Version 0.2.1
retains Apache-2.0; versions 0.2.0 and earlier retain their FSL-1.1-ALv2
grants. Existing release tags, published archives and already prepared Apache
release artifacts are not relicensed or replaced. Retained permissive license texts describe those
