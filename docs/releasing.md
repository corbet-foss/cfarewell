...
1. Update versions and CHANGELOG.md (a `## X.Y.Z - date` section becomes the
   ...
   `bash js/@corbet-labs/cfarewell/scripts/sync-assets.sh`. Commit to `main`.
...
Until npm and PyPI trust `corbet-foss/cfarewell:release.yml`, upload them from the
...
```sh
tag=vX.Y.Z repo=corbet-foss/cfarewell rev=27c248aefa3c7198be6716a884d290c717774b21
