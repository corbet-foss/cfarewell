...
Deno can use `npm:@corbet-foss/cfarewell`. The browser export bundles runtime
...
The JSR package is
[`@corbet-foss/cfarewell`](https://jsr.io/@corbet-foss/cfarewell@0.3.0):

```sh
deno add jsr:@corbet-foss/cfarewell@0.3.0
```
