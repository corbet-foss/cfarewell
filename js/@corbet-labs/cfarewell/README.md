...
See the [installation guide](https://github.com/corbet-labs/cfarewell/blob/main/docs/installation.md)
...
Behavior is defined by [the locale tables](https://github.com/corbet-labs/cfarewell/tree/main/tables)
and [shared conformance vectors](https://github.com/corbet-labs/cfarewell/tree/main/tests/vectors).
...
See [the release guide](https://github.com/corbet-labs/cfarewell/blob/main/docs/releasing.md)
...
under [LGPL-3.0-only](https://github.com/corbet-labs/cfarewell/blob/main/LICENSES/LGPL-3.0-only.txt)
[WITH LGPL-3.0-linking-exception](https://github.com/corbet-labs/cfarewell/blob/main/LICENSES/LGPL-3.0-only%20WITH%20LGPL-3.0-linking-exception.txt),
with the incorporated [GPL version 3](https://github.com/corbet-labs/cfarewell/blob/main/LICENSES/GPL-3.0-only.txt).
...
See the [licensing notes](https://github.com/corbet-labs/cfarewell/blob/main/LICENSE.md) for distribution conditions and retained notices.
Contributions use the [Contributor License Agreement](https://github.com/corbet-labs/cfarewell/blob/main/CLA.md).
